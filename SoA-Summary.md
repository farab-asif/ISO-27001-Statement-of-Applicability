...
|-----------|--------------|-----------|--------|-------|
| A.5.1 | Policies for information security | Y | Planned | IT & Security / Top Management |
| A.5.2 | Information security roles & responsibilities | Y | Planned | Top Management / IT & Security |
| A.5.3 | Segregation of duties | Y | Planned | IT & Security |
| ... | ... | ... | ... | ... |

> Full details (justification, risks, evidence) are stored in `ISO_27001_SoA_Complete_93_Controls.csv`.
